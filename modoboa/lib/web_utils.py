...
def size2integer(value, unit="B"):
    ...
    * G|g for GB
    ...
    :param unit: the unit to convert to, either "B" for byte or "MB" for megabyte
    :return: the corresponding integer value
    """

    if unit!="B" and unit!="MB":
        raise ValueError("Entry should either be MB or B")
